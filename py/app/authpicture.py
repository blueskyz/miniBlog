...
class picChecker():   
	...
	param: 很多，如下  
		...
		backgroundColor 背景色  
		foregroundColor 前景色  
			当mode=RGB时，backgroundColor,foregroundColor为 tutle类型  
	...
	def __init__(self,chars = initChars(),size = (120,30), fontsize = 22,
			begin = (5,-2),outputType = 'PNG',mode = 'RGB' ,   
			backgroundColor = (255,255,255), foregroundColor = (0,0,255),   
			fonttype = "/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc",
			length = 5,jamNum = (1,3),   
			pointBorder = (40,39)):   
		"""  
		初始化配置  
	...
	def createChecker(self): 
		...
		im.save(outstr, self.outputType)  
		return {"str": randStr, "image": outstr}  
